pipeline {
  ...
  stages {
    ...
    stage('Scan') {
      steps {
        echo 'start scan'
        discordSend(webhookURL: 'https://discord.com/api/webhooks/1174361941305741352/-zar7V61kIeLtcG6XGEj464IRm4jLD-kq0c0_AD0WJKczil3wRJsNKR-70iGP8-vmYW6', customUsername: 'SUPERVISION_JENKINS', description: 'SCAN_START', title: 'INFO_START')
